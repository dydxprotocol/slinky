...
First, add the [x/marketmap](https://github.com/dydxprotocol/slinky/blob/main/x/marketmap/README.md) and [x/oracle](https://github.com/dydxprotocol/slinky/tree/main/x/oracle) keepers to the application.
