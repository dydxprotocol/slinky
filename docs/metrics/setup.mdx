...
[Sidecar Dashboard JSON file](https://github.com/dydxprotocol/slinky/blob/main/grafana/provisioning/dashboards/side-car-dashboard.json)

### Application

[Application Dashboard JSON file](https://github.com/dydxprotocol/slinky/blob/main/grafana/provisioning/dashboards/chain-dashboard.json)